 ...
 * */
export async function getRepositoryCommitsBetweenCommits(repositoryPath: string, baseCommitHash: string, targetCommitHash: string): Promise<Commit[]>
{
    const SEPARATOR = '|àωⓈ⒧|';
    const LOG_SEPARATOR = '|⑨⑨ⓂⓂ|';
    const stdout = await execPromise(
 ...
 * */
export async function getRepositoryCommits(repositoryPath: string, targetCommitHash: string): Promise<Commit[]>
{
    const SEPARATOR = '|àωⓈ⒧|';
    const LOG_SEPARATOR = '|⑨⑨ⓂⓂ|';
    const stdout = await execPromise(
