...
export default (router: Router<IState, IContext>) =>
{
    router.get(REPOSITORY, JSONQuerystringParser(), repository())
        ...
        .post(SET_NAME, sessionChecker(), bodyParser(), setName())
        .post(SET_DESCRIPTION, sessionChecker(), bodyParser(), setDescription())
        .post(SET_IS_PUBLIC, sessionChecker(), bodyParser(), setIsPublic())
